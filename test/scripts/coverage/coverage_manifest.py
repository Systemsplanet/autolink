...
#
# The list of which test binaries link each library source must not
# be a hardcoded map hand-edited in coverage_merge.sh: a new suite
# added to TEST_BINS would silently miss coverage otherwise (see
# AGENTS.md rule 4).
#
