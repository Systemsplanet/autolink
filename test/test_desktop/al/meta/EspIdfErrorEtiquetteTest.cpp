...
const std::vector<CallSite> REQUIRED_SITES = {
    { "src/al/hal/EspHal.cpp", "uart_driver_install", "esp_err_to_name" },
    { "src/al/hal/EspHal.cpp", "uart_param_config", "esp_err_to_name" },
    { "src/al/hal/EspHal.cpp", "uart_set_pin", "esp_err_to_name" },
    { "src/al/hal/EspHal.h", "uart_set_baudrate", "esp_err_to_name" },
    { "src/al/hal/EspHal.cpp", "gpio_set_pull_mode", "esp_err_to_name" },

    // AutoLinkWeb's httpd / esp_timer call sites are split across two
    // TUs: AutoLinkWebHttpd.cpp owns httpd bring-up plus its own
    // esp_timer_create; AutoLinkWebLifecycle.cpp owns ~AutoLinkWeb(),
    // whose teardown also calls esp_timer_stop/delete and httpd_stop
    // (hence those three appearing in both). AutoLinkWebHandlersData.cpp
    // and AutoLinkWebHandlersOta.cpp have no ESP-IDF calls that
    // return esp_err_t, so neither is here.
    { "src/al/web/handlers/AutoLinkWebHttpd.cpp", "httpd_register_uri_handler",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebHttpd.cpp", "httpd_start",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebHttpd.cpp", "esp_timer_create",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebHttpd.cpp", "esp_timer_start_periodic",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebHttpd.cpp", "esp_timer_stop",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebHttpd.cpp", "esp_timer_delete",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebHttpd.cpp", "httpd_stop",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebLifecycle.cpp", "esp_timer_stop",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebLifecycle.cpp", "esp_timer_delete",
      "esp_err_to_name" },
    { "src/al/web/handlers/AutoLinkWebLifecycle.cpp", "httpd_stop",
      "esp_err_to_name" },
};
