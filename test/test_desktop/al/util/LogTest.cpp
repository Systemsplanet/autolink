// Log sink fan-out, level filter, truncation warning.
...
static void captureSink(char sev, const char *tag,
                        const char *msg, void *)
{
...
void test_level_filtering()
{
    ...
    assert(g_captured[0].sev == 'E' &&
           g_captured[0].msg == "err1");
    ...
    assert(g_captured[1].sev == 'E' &&
           g_captured[1].msg == "err2");
    assert(g_captured[2].sev == 'W' &&
           g_captured[2].msg == "warn2");
    ...
    assert(g_captured[3].sev == 'E' &&
           g_captured[3].msg == "err3");
    assert(g_captured[4].sev == 'I' &&
           g_captured[4].msg == "info3");
    ...
    assert(g_captured[5].sev == 'E' &&
           g_captured[5].msg == "err4");
    assert(g_captured[6].sev == 'I' &&
           g_captured[6].msg == "info4");
    assert(g_captured[7].sev == 'D' &&
           g_captured[7].msg == "dbg4");
    ...
    assert(g_captured[8].sev == 'E' &&
           g_captured[8].msg == "err5");
    assert(g_captured[9].sev == 'I' &&
           g_captured[9].msg == "info5");
    assert(g_captured[10].sev == 'D' &&
           g_captured[10].msg == "dbg5");
    assert(g_captured[11].sev == 'V' &&
           g_captured[11].msg == "vb5");
...
{
    std::cout << "\n=== Test: Sink Context Pointer ==="
              << std::endl;
    Log &L = Log::log();
    L.setLevel(Log::DEBUG);
    int marker = 0xCAFE;
    auto fn = [](char, const char *, const char *,
                 void *ctx) {
