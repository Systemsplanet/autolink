...
void test_dead_code_boundary() {
    ...
    chk("src/al/link/Link.cpp", "retxNeeded_");
    ...
    // _unlocked suffix).
    chk("src/al/link/Link.cpp", "void Link::sendFrame(");
    ...
    chk("src/al/link/Link.cpp", "popRetransmitSlot");
    ...
    chk("src/al/link/Link.cpp", "swpRxBytes");
