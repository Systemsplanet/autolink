...
void test_dead_code_boundary() {
    ...
    for (const char *tu :
         { "LinkCore.cpp", "LinkTx.cpp", "LinkRx.cpp", "LinkSweepGlue.cpp",
    ...
    for (const char *tu :
         { "LinkCore.cpp", "LinkTx.cpp", "LinkRx.cpp", "LinkSweepGlue.cpp",
           "LinkTimers.cpp", "LinkApi.cpp" }) {
        chk((std::string("src/al/link/") + tu).c_str(), "reorderAdvanceRxSeq");
    }
    ...
    chk("src/al/link/LinkTimers.cpp", "onTimerLck_unlocked");
    chk("src/al/link/LinkSweepGlue.cpp", "handleLck_unlocked");
    ...
    // was the only consumer in the sweep
