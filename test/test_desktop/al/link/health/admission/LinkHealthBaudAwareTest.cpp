...
// baud than at a fast one. The RTO is computed from
// the real chunk size: 2 * (MAX_CHUNK + frame_overhead)
// * 10 / baud * 1000 ms. A 9600-baud link should have
// an RTO of ~520 ms (a 250-byte MAX_CHUNK payload at
// 9600 baud takes ~260 ms, well past the 500 ms RTO
// floor); a 115200-baud link should have an RTO of the
// static syncAckTimeoutMs floor. Proving these differ
// is the no-op-rejection pin.
