// Auto-generated split of earlier LinkMessageTest.cpp.
...
void test_send_rejections_log_errors() {
    ...
    std::vector<uint8_t> oversized((int)AUTOLINK_DEFAULT_MAX_MSG + 1, 0);
    assert(a.sendMsg(oversized.data(), (int)AUTOLINK_DEFAULT_MAX_MSG + 1) ==
           false);
