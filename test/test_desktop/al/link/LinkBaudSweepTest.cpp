// UtilBaudSweep score tracking + best-pick with
// min-hit floor.
...
{
    std::cout << "\n=== Test: Flaky Top Baud Falls "
                 "Back to Reliable One ==="
              << std::endl;
...
int main()
{
    std::cout << "=== Running UtilBaudSweep Tests ==="
              << std::endl;
