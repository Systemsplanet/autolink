...
// across two onRx() delivery chunks used to fall through to the COBS
// framer instead of being held and reassembled — costs a frameErr
// and loses the CTRL frame. MockHal's single-shot tx() delivery
// never exercised this; real UART reads land on arbitrary byte
// boundaries. Fix: okCarry_ holds a trailing 0xAA (or 0xAA 0x55...)
