...
public:
    ...
    // The wire ACK frame carries bytes-recvd. The MockListener
    // records both the seq and the reported bytes-recvd so tests
    // can pin the contract end-to-end (e.g. ack-byte round-trip).
