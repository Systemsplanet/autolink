...
// to P3. The prior shape decremented spdI from 0
// to -1 on every tick in a single-baud config,
// falling back to P1 in a 250 ms loop, never
// reaching P3. Now guarded by spdI <= 0 in
// LinkTimersSwp.cpp.
