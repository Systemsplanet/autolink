...
// slowest (N-1). Prior shape wrapped spdI to N-1 then
// immediately decremented to N-2 before the RX baud
// was set, so the slave never listened at the slowest
// baud — the exact baud the master's P1/fallback
// parked on. The baud-mismatch storm in the field log
// was the symptom: master walked to the slowest,
// slave camped at N-2.
//
