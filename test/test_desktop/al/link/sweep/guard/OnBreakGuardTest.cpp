...
static void test_onbreak_in_ok_still_resets() {
    ...
    // prior shape forced the slave to P1 slowest, which
    // is exactly the master/slave sweep-phase skew the
    // the prior release field log surfaced (100% 9600 fallback).
