...
// Pong's P2->P3 transition calls enterPhase3 directly.
// enterPhase3 itself sets phase_=PHASE3 and resets
// phase3Acks_, so a redundant setPhase+reset would be
// a no-op write followed by an override. Pin:
