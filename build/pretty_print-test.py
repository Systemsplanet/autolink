...
# ---------------------------------------------------------------------------
# Generated-header skip: src/al/web/generated/*.h are the output of
...
with tempfile.TemporaryDirectory() as td:
    # Mirror the real layout: src/al/web/generated/DashboardCss.h
    # so the path-prefix matcher in _is_generated() hits.
    gen_dir = os.path.join(td, 'src', 'al', 'web', 'generated')
    os.makedirs(gen_dir)
    gen_p = os.path.join(gen_dir, 'DashboardCss.h')
    original = (
        'static const char DASHBOARD_CSS[] = R"DASH('
        'body{margin:0}'
        ')DASH";\n')
    ...
    _ok(
        '10. generated header (src/al/web/generated/*.h): skipped, '
