...
# One install cascade per process. The apt/pip attempts
# each burn seconds against a dead network; re-running
# them per file turns a multi-file pass into minutes.
...
def _install_clang_format() -> bool:
    ...
    for cmd in cmds:
        try:
            ...
            continue
    _install_result = _have_clang_format()
    return _install_result
