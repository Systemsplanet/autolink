...
public:
    ...
    // Per-slot retx count for the honest-drop gate — retxCountTotal()
    // is window-wide and wrong here; the storm-stuck escalation
    // needs the base's own count. Pinned by GbnStuckForcesRetxTest.
