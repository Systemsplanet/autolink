...
int formatStatsJson(const WebSnapshot *s, int logLevel, const char *version,
    ...
    return snprintf(
        out, (size_t)outLen,
        "{\"state\":\"%s\",\"errCount\":%lu, \"errTotal\":%llu, \"lostMsgs\":%llu, \"txBps\":%lu,\"rxBps\":%lu, \"txTotal\":%llu,\"rxTotal\":%llu, \"rssi\":%d,\"freeHeap\":%lu,\"uptimeS\":%lu, \"baudRate\":%lu,\"lvl\":%d,\"mode\":%u, \"msgPaused\":%u, \"linkMode\":%u, \"linkModeLabel\":\"%s\", \"txDelayMs\":%d, \"role\":\"%s\", \"version\":\"%s\"}",
