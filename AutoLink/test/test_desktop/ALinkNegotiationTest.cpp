...
void test_best_baud_selection() {
 ...
 MockHal sHal;
 AutoLinkConfig cfg; cfg.allowedBauds[0]=9600; cfg.allowedBauds[1]=19200; cfg.allowedBauds[2]=38400; cfg.allowedBauds[3]=57600; cfg.allowedBaudsCount=4; cfg.pingSamplesPerBaud = 1;
 cfg.fastBaudLock = false;
 ALink pong(sHal, false, cfg);
 pong.begin();
 assert(pong.getState() == State::SWP);
...
void test_top_down_fast_ack_locks_top() {
 ...
 AutoLinkConfig cfg;
 cfg.allowedBauds[0]=115200; cfg.allowedBauds[1]=57600; cfg.allowedBauds[2]=38400; cfg.allowedBauds[3]=19200; cfg.allowedBauds[4]=9600; cfg.allowedBaudsCount=5;
 ...
 int fastAckPayload = sHal.txBuf[3]; //: [0xAA, 0x55, cobsSeq, payload, CRC8]
 pipe_data(sHal, mHal);
